...
<div>
  ...
  :style="{'background' : 'url(' + require(`@/${text.banner}`) +')', 'background-size' : 'cover' }">
    <div class="row min-vh-100 justify-content-start align-items-center p-5">
      <!-- image filter layer -->
      <div class="h-100 w-100 position-absolute start-0" style="background: rgba(0,0,0,0.2);"></div>
      <div class="col-lg-8 text-focus-in">
        <div class="d-flex flex-column justify-content-center align-items-start p-5" style="background: rgba(0,0,0,0.6); backdrop-filter: blur(10px); border-radius: 33px; min-height: 50vh">
  ...
  <div class="container-fluid py-5 bg-light">
    ...
    <!-- text div -->
    <div class="container p-5 shadow-lg text-light bg-dark" style="border-radius: 33px">
